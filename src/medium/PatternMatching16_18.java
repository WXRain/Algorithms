 ...
 * 
 * 输入： pattern = "abba", value = "dogdogdogdog" 输出： true 解释：
 * "a"="dogdog",b=""，反之也符合规则 提示：
 * 
 * 0 <= len(pattern) <= 1000 0 <= len(value) <= 1000
 * 你可以假设pattern只包含字母"a"和"b"，value仅包含小写字母。
 * 
 * 来源：力扣（LeetCode） 链接：https://leetcode-cn.com/problems/pattern-matching-lcci
...
public class PatternMatching16_18 {
	public boolean patternMatching(String pattern, String value) {
		...
		// 比如第一个b的起始坐标为prea*aLen，那他的字符串为value.substring(prea*aLen,
		// prea*aLen+bLen);
