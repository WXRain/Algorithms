...
/**
 * 
 * @author rain 爱丽丝参与一个大致基于纸牌游戏 “21点” 规则的游戏，描述如下：
 * 
 ...
 * 
 *         输入：N = 6, K = 1, W = 10 输出：0.60000 说明：爱丽丝得到一张卡，然后停止。 在 W = 10 的 6
 *         种可能下，她的得分不超过 N = 6 分。 示例 3：
 * 
 *         输入：N = 21, K = 17, W = 10 输出：0.73278 提示：
 * 
 *         0 <= K <= N <= 10000 1 <= W <= 10000 如果答案与正确答案的误差不超过
